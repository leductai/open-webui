			...
			>
				...
				>
					<path
						...
						d="M13.19 8.688a4.5 4.5 0 0 1 6.364 6.364l-1.757 1.757a4.5 4.5 0 0 1-6.364 0m1.757-9.9-1.757 1.757a4.5 4.5 0 0 0 0 6.364m-3.182-1.06a4.5 4.5 0 0 1 0-6.364l1.757-1.757a4.5 4.5 0 0 1 6.364 0"
					/>
				</svg>
				<div class="flex items-center">{$i18n.t('Copy Voice Link')}</div>
			</button>
