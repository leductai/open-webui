...
>
	{#if confirmEdit}
		<div
			...
			class="w-full flex justify-between rounded-2xl px-[11px] py-[6px] border {id === $chatId ||
			confirmEdit
				? ($settings?.highContrastMode ?? false)
					? 'bg-[linear-gradient(180deg,rgba(255,252,247,0.98)_0%,rgba(244,235,222,0.92)_100%)] dark:bg-[rgba(26,38,45,0.92)] border-[rgba(204,190,171,0.82)] dark:border-[rgba(87,105,114,0.42)] selected'
					: 'bg-[linear-gradient(180deg,rgba(255,252,247,0.98)_0%,rgba(244,235,222,0.92)_100%)] dark:bg-[rgba(26,38,45,0.92)] border-[rgba(204,190,171,0.82)] dark:border-[rgba(87,105,114,0.42)] selected'
				: selected
					? ($settings?.highContrastMode ?? false)
						? 'bg-[linear-gradient(180deg,rgba(255,252,247,0.98)_0%,rgba(244,235,222,0.92)_100%)] dark:bg-[rgba(26,38,45,0.92)] border-[rgba(204,190,171,0.82)] dark:border-[rgba(87,105,114,0.42)] selected'
						: 'bg-[linear-gradient(180deg,rgba(255,252,247,0.98)_0%,rgba(244,235,222,0.92)_100%)] dark:bg-[rgba(26,38,45,0.92)] border-[rgba(204,190,171,0.82)] dark:border-[rgba(87,105,114,0.42)] selected'
					: 'notebook-sidebar-button border-transparent'} whitespace-nowrap text-ellipsis relative {generating
				? 'cursor-not-allowed'
				: ''}"
		>
			<input
			...
			confirmEdit
				...
				: selected
					? ($settings?.highContrastMode ?? false)
						? 'bg-[linear-gradient(180deg,rgba(255,252,247,0.98)_0%,rgba(244,235,222,0.92)_100%)] dark:bg-[rgba(26,38,45,0.92)] border-[rgba(204,190,171,0.82)] dark:border-[rgba(87,105,114,0.42)] selected'
						: 'bg-[linear-gradient(180deg,rgba(255,252,247,0.98)_0%,rgba(244,235,222,0.92)_100%)] dark:bg-[rgba(26,38,45,0.92)] border-[rgba(204,190,171,0.82)] dark:border-[rgba(87,105,114,0.42)] selected'
					: 'notebook-sidebar-button border-transparent'} whitespace-nowrap text-ellipsis"
			href="/c/{id}"
			on:click={() => {
				dispatch('select');
	...
	{#if !readonly}
        ...
        {id === $chatId || confirmEdit
				? ($settings?.highContrastMode ?? false)
					? 'from-[rgba(247,242,234,0.98)] dark:from-[rgba(26,38,45,0.94)] selected'
					: 'from-[rgba(247,242,234,0.98)] dark:from-[rgba(26,38,45,0.94)] selected'
				: selected
					? ($settings?.highContrastMode ?? false)
						? 'from-[rgba(247,242,234,0.98)] dark:from-[rgba(26,38,45,0.94)] selected'
						: 'from-[rgba(247,242,234,0.98)] dark:from-[rgba(26,38,45,0.94)] selected'
					: 'invisible group-hover:visible from-[rgba(247,242,234,0.98)] dark:from-[rgba(26,38,45,0.94)]'}
